...
export default function Dashboard() {
  ...
  if (!authenticated) {
    return (
      <LoginScreen
        login={login}
        title="Songjam Leaderboard"
        subtitle="create a mindshare campaign for your project"
      />
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[oklch(0.145_0_0)] via-[oklch(0.165_0_0)] to-[oklch(0.125_0_0)]">
      ...
      <div className="relative z-20 px-4 py-4">
        <Navbar hideNavigation={true} title="Songjam Leaderboard" />
      </div>
      ...
      <div className="relative z-10 text-center py-8 px-4">
        ...
        >
          create a mindshare campaign for your project
        </motion.p>
      </div>
